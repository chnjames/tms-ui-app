<template>
  <view class="container">
    ...
    <view class="auth-box">
      ...
      <u--form labelPosition="left" :model="formData" ref="form">
        <u-form-item labelWidth="60" borderBottom ref="item-mobile">
          <u--input  v-model="formData.username" clearable placeholder="请填写用户名" prefixIcon="account-fill" border="none"></u--input>
        </u-form-item>

        <u-gap height="20"></u-gap>

        <u-form-item v-if="currentModeIndex === 0" labelWidth="60" borderBottom ref="item-password">
          <u-input :type="inputType" maxlength="16" v-model="formData.password" prefixIcon="lock-fill" placeholder="请填写密码" border="none">
    ...
    <view class="auth-footer">
      <u--text type="primary" @click="bindForgot" align="center" text="忘记密码"></u--text>
    </view>
  </view>
</template>
